...
<h1 class="ml7">
  <span class="text-wrapper">
    <span class="letters">Welcome Home.</span>
  </span>
</h1>
...
<div id="container">
    <input type = "submit" name = "submit" value = "Log In" style = "font-size: 20px"></input></form>
</div> <!--Close Container-->

<div class="box">
    <p style="font-size: 20px;">Looking to Register? <a href="registration.php">Click Here</a></p>
</div> <!--Close Box-->

<div id="container">
	<div class="box">
		<p style="font-size: 20px;"><a href="../index.php">Home Page</a></p>
	</div> <!--Close Box-->
</div> <!--Close Container-->
